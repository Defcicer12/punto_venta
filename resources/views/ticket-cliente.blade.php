...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Alta de servicio a equipo</title>
  </head>
  <body>
    <header class="clearfix">
      ...
      <h1>Alta de servicio a equipo</h1>
    ...
    <main>
      <table>
        <thead>
          <tr>
            <th class="service">Equipo</th>
            <th class="desc">Fecha de alta</th>
          </tr>
        </thead>
        <tbody>
          <tr>
          <td class="service">{{$orden->equipo}}</td>
            <td class="desc">{{ $orden->fecha}}</td>
          </tr>
        </tbody>
      </table>
      <div id="notices">
        <div>Aviso:</div>
        <div class="notice">Ticket valido para recoger tú equipo en tienda</div>
      </div>
    </main>
    <footer>
      Siempre fallan sa de cv
    </footer>
  </body>
</html>
